...
var pokedex = {}; // {1 : {"name" : "blubasaur", "img" : url, "type" : ["grass", "poison"], "desc" : "...."} }
...
async function getPokemon(num) {
   ...
   pokedex[num] = {"name" : pokemonName, "img" : pokemonImg, "types" : pokemonType, "description" : pokemonDesc}
}
...
function updatePokemon() {
    ...
    while (typesDiv.firstChild) {
        typesDiv.removeChild(typesDiv.firstChild); // Correctly removes child elements
    }
